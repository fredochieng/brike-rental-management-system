<div class="modal fade" id="confirmPaymentModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="custom-select" name="property_id" id="mpesa_payments_id" required>
