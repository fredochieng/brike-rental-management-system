...
<div class="vertical-align-wrap">
	<div class="vertical-align-middle auth-main">
		<div class="auth-box">
            <div class="top">
                <img src="<?php echo e(url('/')); ?>/assets/img/logo-white.svg" alt="Lucid">
            </div>
			<div class="card">
                <div class="header">
                ...
                <div class="body">
                    <form class="form-auth-small">
                        ...
                        <div class="bottom">
                            <span class="helper-text">Already have an account? <a href="<?php echo e(route('authentication.login')); ?>">Login</a></span>
                        </div>
                    </form>
