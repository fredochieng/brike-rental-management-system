<?php $__env->startSection('title', 'Rent Payment Trackers'); ?>
<?php $__env->startSection('parentPageTitle', 'Rent Payments'); ?>

<?php $__env->startSection('content'); ?>
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <?php echo Form::open(['url' => action('MonthlyPaymentController@index'), 'method' => 'get']); ?>
