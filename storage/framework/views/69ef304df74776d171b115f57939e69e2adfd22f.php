<div class="modal fade" id="addCategoryModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo Form::open(['url' => action('PropertyCategoriesController@store'), 'method' => 'post']); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <?php echo e(Form::text('category_name', null, ['class' => 'form-control', 'required', 'placeholder' => 'Enter category name' ])); ?>
