<?php $__env->startSection('title', 'Manage Tenant'); ?>
<?php $__env->startSection('parentPageTitle', 'Tenant'); ?>
        ...
        <div class="row clearfix">
                ...
                <div class="card">
                    <div class="body">
                        <h3 class="number count-to" data-from="0" data-to="128" data-speed="2000"
                            data-fresh-interval="700"><?php echo e($currency_symbol); ?> <?php echo e($sum_tot_payments); ?></h3>
            ...
            <div class="col-lg-12 col-md-6">
                <div class="card">
                    <div class="body">
                        <h3 class="number count-to" data-from="0" data-to="128" data-speed="2000"
                            data-fresh-interval="700"><?php echo e($tenancy_period); ?> Months</h3>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="align-right">
                                <?php echo e($tenant->t_name); ?>

                            </td>
                        </tr>
                        <tr>
                            <td><strong>Phone Number</strong></td>
                            <td class="align-right"><?php echo e($tenant->t_phone); ?></td>
                        </tr>
                        <tr>
                            <td><strong>ID/Reg Number</strong></td>
                            <td class="align-right"><?php echo e($tenant->t_id_no); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Email Address</strong></td>
                            <td class="align-right"><?php echo e($tenant->t_email); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Alt Phone Number</strong></td>
                            <td class="align-right"><?php echo e($tenant->t_alt_phone); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Property Name</strong></td>
                            <td class="align-right"><?php echo e($tenant->prop_name); ?></td>
                        </tr>

                        <tr>
                            <td><strong>Room Variation</strong></td>
                            <td class="align-right"><?php echo e($room_assignment->var_name_value); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Room Number</strong></td>
                            <td class="align-right"><?php echo e($room_assignment->room_no); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Tenancy Start Date</strong></td>
                            <td class="align-right"><?php echo e($room_assignment->r_start_date); ?></td>
                        </tr>
                        <tr>
                            <td><strong>Tenancy End Date</strong></td>
                            <?php if($room_assignment->r_end_date == ''): ?>
                            <td class="align-right" style="color:green">Still an active tenant</td>
                            <?php else: ?>
                            <td class="align-right"><?php echo e($room_assignment->r_end_date); ?>
                    ...
                    <div class="body">
                        <ul class="list-unstyled feeds_widget">
                            ...
                            <li>
                                ...
                                <div class="feeds-body">
                                    <a href="#" data-toggle="modal" disabled
                                        data-target="#unassignRoomModal_<?php echo e($tenant->tenant_id); ?>" data-backdrop="static"
                            ...
                            <li>
                                ...
                                <div class="feeds-body">
                                    <a href="#" data-toggle="modal" disabled
                                        data-target="#reactivateTenantModal_<?php echo e($tenant->tenant_id); ?>"
...
<?php echo $__env->make('tenants.modals.modal-unassign-room', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('tenants.modals.modal-reactivate-tenant', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
