        ...
        <div class="card chat-app">
            <div id="plist" class="people-list">
                ...
                <ul class="list-unstyled chat-list mt-2 mb-0">
                    <li class="clearfix">
                        <img src="{{asset('assets/img/xs/avatar1.jpg')}}" alt="avatar" />
                        <div class="about">
                    ...
                    <li class="clearfix active">
                        <img src="{{asset('assets/img/xs/avatar2.jpg')}}" alt="avatar" />
                        <div class="about">
                    ...
                    <li class="clearfix">
                        <img src="{{asset('assets/img/xs/avatar3.jpg')}}" alt="avatar" />
                        <div class="about">
                    ...
                    <li class="clearfix">
                        <img src="{{asset('assets/img/xs/avatar7.jpg')}}" alt="avatar" />
                        <div class="about">
                    ...
                    <li class="clearfix">
                        <img src="{{asset('assets/img/xs/avatar8.jpg')}}" alt="avatar" />
                        <div class="about">
                    ...
                    <li class="clearfix">
                        <img src="{{asset('assets/img/xs/avatar9.jpg')}}" alt="avatar" />
                        <div class="about">
