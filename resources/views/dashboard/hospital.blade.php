        ...
        <div class="card">
            ...
            <div class="body">
                <div class="sparkline" data-type="line" data-spot-Radius="1"
                    ...
                    data-spot-Color="rgb(96, 125, 139, 0.7)" data-offset="90" data-width="100%" data-height="50px"
                    data-line-Width="1" data-line-Color="#a89ee3" data-fill-Color="#a89ee3">
        ...
        <div class="card">
            ...
            <div class="body">
                <div class="sparkline" data-type="line" data-spot-Radius="1"
                    ...
                    data-spot-Color="rgb(120, 184, 62, 0.7)" data-offset="90" data-width="100%" data-height="50px"
                    data-line-Width="1" data-line-Color="#ffcd55" data-fill-Color="#ffcd55"> 6,4,7,6,9,3,3,5,7,4,2,3,7,6
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="body">
                <div class="sparkline" data-type="bar" data-width="97%" data-height="50px" data-bar-Width="5"
                    data-bar-Spacing="10" data-bar-Color="#f56582">2,8,5,3,1,7,9,5,6,4,2,3,1</div>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="progress-container m-b-20">
                            ...
                            <div class="progress progress-xs">
                                <div class="progress-bar" role="progressbar" aria-valuenow="42" aria-valuemin="0"
                ...
                <div class="table-responsive table_middel">
                    <table class="table m-b-0">
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td><img src="{{url('/')}}/assets/img/xs/avatar3.jpg"
                                        class="rounded-circle width30 m-r-15" alt="profile-image"><span>John</span></td>
                            ...
                            <tr>
                                <td>2</td>
                                <td><img src="{{url('/')}}/assets/img/xs/avatar1.jpg"
                                        class="rounded-circle width30 m-r-15" alt="profile-image"><span>Jack Bird</span>
                                </td>
                            ...
                            <tr>
                                <td>3</td>
                                <td><img src="{{url('/')}}/assets/img/xs/avatar4.jpg"
                                        class="rounded-circle width30 m-r-15" alt="profile-image"><span>Dean Otto</span>
                                </td>
                                <td><span class="text-info">123 6th St. Melbourne, FL 32904</span></td>
                                <td>Sept 13, 2017</td>
                                <td>Sept 23, 2017</td>
                                ...
                                <td>
                                    <div class="progress progress-xs">
                                        <div class="progress-bar progress-bar-success" role="progressbar"
                                            ...
                                            style="width: 15%;"> <span class="sr-only">15% Complete</span> </div>
                                    </div>
                                </td>
                                <td><span class="badge badge-success">Admit</span></td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td><img src="{{url('/')}}/assets/img/xs/avatar2.jpg"
                                        class="rounded-circle width30 m-r-15" alt="profile-image"><span>Jack Bird</span>
                                </td>
                            ...
                            <tr>
                                <td>5</td>
                                <td><img src="{{url('/')}}/assets/img/xs/avatar5.jpg"
                                        class="rounded-circle width30 m-r-15" alt="profile-image"><span>Hughe L.</span>
                                </td>
                                <td><span class="text-info">4 Shirley Ave. West Chicago, IL 60185</span></td>
                                <td>Sept 18, 2017</td>
                                <td>Sept 18, 2017</td>
                                ...
                                <td>
                                    <div class="progress progress-xs">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            ...
                                            style="width: 85%;"> <span class="sr-only">85% Complete</span> </div>
                                    </div>
                                </td>
                                <td><span class="badge badge-success">Admit</span></td>
                            </tr>
