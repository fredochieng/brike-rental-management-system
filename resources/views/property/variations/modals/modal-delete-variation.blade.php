<div class="modal fade" id="deleteVariation_{{ $item->variation_id }}" tabindex="-1" role="dialog" data-backdrop="static"
    data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            {!!
            Form::open(['action'=>['PropertyVariationsController@deleteVariation',$item->variation_id],'method'=>'POST'])
            !!}
