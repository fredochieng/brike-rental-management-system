    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="body">
                ...
                <div class="progress">
                    <div class="progress-bar l-turquoise" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 46%">
                        <span class="sr-only">60% Complete (warning)</span>
                    </div>
                </div>
                <div class="progress">
                ...
                <div class="progress progress-lg">
                    <div class="progress-bar l-coral" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 55%">
                        <span class="sr-only">60% Complete (danger)</span>
                    </div>
                </div>
            </div>
