    ...
    */
    ...
    public function store( Request $request ) {
        ...
        if ( $contact_source == 1 ) {
            ...
            foreach ( $recepient_contacts as $key => $value ) {

                $message = new Message();
                $message->message_title = $message_title;
                $message->message = $text;
                $message->phone_no = $value;
            ...
            // dd( $recepient_contacts );
            // $recepient_contacts = explode( ',', $recepient_contacts );
            // $recepient_contacts = array( '254724543675', '254703546454', '254714353435' );
            // $tenants = RoomAssignment::getRoomAssignments()->where( 'property_id', $property_id );

            // foreach ( $tenants as $key => $value ) {
            //     $message = new Message();
            //     $message->message_title = 'Test SMS';
            //     $message->message = 'Please work';
            //     $message->phone_no = '07563356353';
            ...
            //     // } else {
            //     //     $invalid_contacts++;
            //     //     // Toastr::warning( 'SMS not created' );
            //     //     // return back();
            //     // }
            //     // dd( $recepient_contacts );
            ...
            //     // return back();
            //     // } else {
            //     //     Toastr::warning( 'One or more phone numbers are incorrect' );
            //     //     return back();
            //     // }
